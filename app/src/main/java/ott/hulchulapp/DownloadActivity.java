...
import ott.hulchulapp.adapters.DownloadHistoryAdapter;
import ott.hulchulapp.adapters.DownloadedVideoListAdapter;
import ott.hulchulapp.adapters.FileDownloadingAdapter;
import ott.hulchulapp.constant.AppUtil;
...
import ott.hulchulapp.models.Work;
import ott.hulchulapp.nav_fragments.DownloadNewFragment;
...
//                activity.getSupportFragmentManager().beginTransaction().replace(R.id.Container, myFragment).addToBackStack(null).commit();
                ...
                ott.hulchulapp.database.DatabaseHelper offlineDatabaseHelper1 = new DatabaseHelper(DownloadActivity.this);
