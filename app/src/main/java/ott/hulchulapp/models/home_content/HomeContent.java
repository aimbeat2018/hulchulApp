...
package ott.hulchulapp.models.home_content;
...
import ott.hulchulapp.database.homeContent.converters.CountryConverter;
import ott.hulchulapp.database.homeContent.converters.FeaturedTvConverter;
import ott.hulchulapp.database.homeContent.converters.FeaturesGenreConverter;
import ott.hulchulapp.database.homeContent.converters.GenreConverter;
import ott.hulchulapp.database.homeContent.converters.GoldConverter;
import ott.hulchulapp.database.homeContent.converters.LatestMovieConverter;
import ott.hulchulapp.database.homeContent.converters.PopularMovieConverter;
import ott.hulchulapp.database.homeContent.converters.PopularStarsConverter;
import ott.hulchulapp.database.homeContent.converters.SliderTypeConverter;
import ott.hulchulapp.database.homeContent.converters.TvSeriesConverter;
