...
import ott.hulchulapp.AppConfig;
import ott.hulchulapp.FinalPaymentActivity;
import ott.hulchulapp.MainActivity;
import ott.hulchulapp.OneUPIPaymentActivity;
import ott.hulchulapp.R;
import ott.hulchulapp.network.RetrofitClient;
import ott.hulchulapp.network.apis.PaymentApi;
import ott.hulchulapp.network.apis.SubscriptionApi;
import ott.hulchulapp.network.model.ActiveStatus;
import ott.hulchulapp.network.model.Package;
import ott.hulchulapp.network.model.SubscriptionHistory;
...
ProgressBar progressBar;
    ...
    private ott.hulchulapp.database.DatabaseHelper databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SharedPreferences sharedPreferences = PaymentResultActivity.this.getSharedPreferences(ott.hulchulapp.utils.Constants.USER_AGE, MODE_PRIVATE);
...
//        Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        if (getIntent() != null) {
            ...
            databaseHelper = new ott.hulchulapp.database.DatabaseHelper(this);
        }
        ...
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, retrofit2.Response<ActiveStatus> response) {
                if (response.code() == 200) {
                    ...
                    ott.hulchulapp.database.DatabaseHelper db = new ott.hulchulapp.database.DatabaseHelper(getApplicationContext());
