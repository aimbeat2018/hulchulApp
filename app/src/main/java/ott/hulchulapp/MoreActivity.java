...
import ott.hulchulapp.more.ApplyPromoCodeActivity;
import ott.hulchulapp.more.HelpActivity;
...
import ott.hulchulapp.network.model.ActiveSubscription;
...
//                mDrawerLayout.closeDrawers();
    ...
    public void onOnSupportClick(View view) {
        ...
        intent.setData(Uri.parse("tel:" + "8655833567"));
        startActivity(intent);
