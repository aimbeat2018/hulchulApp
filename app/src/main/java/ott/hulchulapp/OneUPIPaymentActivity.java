...
//        mobile = "0000000000";
    ...
    private void payWithUpi() {
        ...
        OneUPIPayment.Builder builder = new OneUPIPayment.Builder(this)
                ...
                .setPayeeName("G J MEDIA ENTERTAINMENT")
                .setTransactionId(transactionId)
                .setTransactionRefId(transactionId)
                //  .setPayeeMerchantCode("0618902f-dacf-4f3e-b1ca-f4bf5b622f5e")//one upi  marchant  bigplay key
                // .setPayeeMerchantCode("5fcced4a-0f1d-4529-bd73-d3aa748eaab6")//one upi   hulchul marchant key
