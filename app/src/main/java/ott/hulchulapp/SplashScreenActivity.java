...
import ott.hulchulapp.network.apis.ConfigurationApi;
import ott.hulchulapp.network.model.config.ApkUpdateInfo;
import ott.hulchulapp.network.model.config.Configuration;
